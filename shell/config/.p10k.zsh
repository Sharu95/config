# Generated by Powerlevel10k configuration wizard on 2024-12-05 at 20:47 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{green}'   # green foreground, clean='%76F'
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=green #76
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%F}|%D{%H:%M:%S}'
